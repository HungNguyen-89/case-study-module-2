...
function display() {
  document.getElementById("backgroundPlay").innerHTML = '<label>' +
    '<input type="checkbox" />' +
    '<div class="flip-card">' +
    '<div class="front">' +
    '<div id="txtFront">' +
    ...
    '</div>' +
    '</label>';
  document.getElementById("buttonPlayContainer").innerHTML = '<button class="buttonPlay" onclick="ditiep()">Next <span><i class="fa-solid fa-angles-right"></i> </span></button>';
  get_random_image();
}
...
function ditiep() {
  ...
  if (dem > a.length) {
    ...
    document.getElementById('buttonPlayContainer').innerHTML = '<button class="buttonPlay" onclick="display()">Again <span><i class="fa-solid fa-rotate"></i></i> </span></button>';
    c = [];
    j = 0;
    dem = 1;
  }
